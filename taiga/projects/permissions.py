...
class ProjectPermission(TaigaResourcePermission):
    ...
    destroy_perms = IsSuperUser()  # IsProjectAdmin()
    modules_perms = IsSuperUser()  # IsProjectAdmin()
    list_perms = AllowAny()
    ...
    transfer_validate_token_perms = IsSuperUser()  # & IsAuthenticated() & HasProjectPerm('view_project')
    transfer_request_perms = IsSuperUser()  # IsProjectAdmin()
    transfer_start_perms = IsSuperUser()  # IsObjectOwner()
    transfer_reject_perms = IsSuperUser()  # IsAuthenticated() & HasProjectPerm('view_project')
    transfer_accept_perms = IsSuperUser()  # IsAuthenticated() & HasProjectPerm('view_project')
